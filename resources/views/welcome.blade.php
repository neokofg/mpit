...
<div class="outer__inner">
    <div class="section-mb80 main main_stays-category">
        <div class="main__center center">
            <div class="main__preview"><img src="img/content/main-pic-2.jpg" alt="Main">
                <div class="main__wrap">
                    <h1 class="main__title hero">Поиск отдыха</h1>
                    <div class="main__info info">Бронируй дом в один клик</div>
                </div>
            </div>
                        ...
                        <div class="location js-location location_small">
                            ...
                            <div class="location__body js-location-body">
                                <div class="location__list">
                                    <a class="location__item js-location-item" href="#">Yakutsk, Republic Of Sakha(Yakutia)</a>
                                    <a class="location__item js-location-item" href="#">Moscow, Russia</a>
                                    <a class="location__item js-location-item" href="#">Saint Petersburg, Russia</a>
                                    <a class="location__item js-location-item" href="#">Novosibirsk, Russia</a>
                                    <a class="location__item js-location-item" href="#">Khabarovsk, Russia</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="sorting__center center">
                <div class="sorting__body">
                    <div class="sorting__box">
                        <h2 class="sorting__title h2">Места для отдыха</h2>
                        <div class="sorting__line">
                            <div class="sorting__sale">100+ мест</div>
                            <div class="sorting__details">Март 22 - Март 25</div>
                        </div>
                    </div>
                    <div class="sorting__location">
                        <button class="button-stroke sorting__button js-sorting-button"><span>Показать карту</span>
    ...
    <div class="footer__center center">
        <div class="footer__row">
            <div class="footer__col">
                <a class="footer__logo" href="index.html"><img class="some-icon" src="img/logo-dark.svg" alt="Fleet"><img class="some-icon-dark" src="img/logo-light.svg" alt="Fleet"></a>
            </div>
            <div class="footer__col">
        ...
        <div class="footer__bottom">
            <div class="footer__copyright">© 2023 Команда Simbios.</div>
        </div>
    </div>
</footer>
